...
class FlowchartMainWindow(QtGui.QMainWindow):

    sigClosed = QtCore.Signal()

    def closeEvent(self, e):
        self.sigClosed.emit()
        super(FlowchartMainWindow, self).closeEvent(e)
...
class FlowchartCtrlWidget(QtGui.QWidget):
    ...
    def __init__(self, chart):
        ...
        self.cwWin = FlowchartMainWindow()
        self.cwWin.setAttribute(QtCore.Qt.WA_QuitOnClose, False)
        ...
        self.cwWin.sigClosed.connect(lambda: self.ui.showChartBtn.setChecked(False))
